...
from .operators.unity_fbx import ExportUnityFbx, ExportSubstanceFbx
...
def register():
    ...
    bpy.utils.register_class(ExportSubstanceFbx)
...
def unregister():
    ...
    bpy.utils.unregister_class(ExportSubstanceFbx)
